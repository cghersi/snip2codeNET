...
namespace NppPluginNet
{
    ...
    public class FuncItems : IDisposable
    {
        ...
        public void Remove(string commandName)
        {
            ...
            item._itemName = string.Empty;
            foreach (FuncItem fItem in _funcItems)
            {
                if (fItem._itemName == commandName)
                {
                    item = fItem;
                    break;
                }
            ...
            if (!string.IsNullOrEmpty(item._itemName))
            {
                _funcItems.Remove(item);
                RefreshItems();
            }
        }
